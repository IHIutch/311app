    ...
    <div class="row">
        <div class="col-12 col-md-8 offset-md-2">
            <div class="p-4 bg-white rounded shadow-sm mb-4">
                <form action="<?php $router->pathFor('submit_data')?>" method="post" enctype="multipart/form-data" id="myForm">
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="search" name="search" class="form-control" id="autocomplete" placeholder="123 Main Street...">
                        </div>
                            ...
                            <div class="col-lg-12">
                                <table>
                                    <tr>
                                        ...
                                        <td class="slimField"><input class="field" id="street_number" name="street_num" disabled="true"></td>
                                        <td class="wideField" colspan="2"><input class="field" id="route" name="street_name" disabled="true"></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="custom-file mb-3">
                                <input type="file" name="image[]" class="custom-file-input" id="image-upload" accept="image/*" multiple>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo getenv('GOOGLE');?>&libraries=places&callback=initAutocomplete" async defer>
</script>
